      ...
      >
        ...
        >
          ...
          <a
            ...
            class="lg:hidden inline-block px-8 py-3 text-sm font-semibold text-center text-white transition duration-100 bg-indigo-500 rounded-md outline-none hover:bg-indigo-600 md:text-base"
          >
            Mail me
          </a>
        </nav>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          class="hidden px-8 py-3 text-sm font-semibold text-center text-white transition duration-100 bg-indigo-500 rounded-md outline-none lg:inline-block hover:bg-indigo-600 md:text-base"
        >
          Mail me
        </a>
        <button
